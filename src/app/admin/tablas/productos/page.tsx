...
import { createProducto, updateProducto, deleteProducto } from "../../productos/actions";

export default async function TablasProductosPage({
  searchParams
}: {
  ...
  return (
    <AdminShell
      user={user}
      title="Productos"
      subtitle="Tablas de datos · catálogo en Supabase — visible en la app móvil."
    >
      ...
      <div className="table-card">
        {productos.length === 0 ? (
          <EmptyTable
            ...
            message="Crea el primero con «+ Nuevo producto»."
          />
        ) : (
